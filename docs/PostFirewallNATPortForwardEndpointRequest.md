...
**protocol** | **str** | The IP/transport protocol this port forward rule should match.&lt;br&gt; | 
...
**target** | **str** | The IP address or alias of the internal host to forward matching traffic to.&lt;br&gt; | 
