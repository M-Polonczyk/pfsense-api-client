# PostVPNOpenVPNCSOEndpointRequest
...
------------ | ------------- | ------------- | -------------
**common_name** | **str** | The X.509 common name for the client certificate, or the username for VPNs utilizing password authentication.&lt;br&gt; | 
