...
ha_proxy_backend_action_instance = HAProxyBackendAction.from_json(json)
# print the JSON string representation of the object
print(HAProxyBackendAction.to_json())

# convert the object into a dict
ha_proxy_backend_action_dict = ha_proxy_backend_action_instance.to_dict()
# create an instance of HAProxyBackendAction from a dict
ha_proxy_backend_action_from_dict = HAProxyBackendAction.from_dict(ha_proxy_backend_action_dict)
```
