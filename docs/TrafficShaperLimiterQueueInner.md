# TrafficShaperLimiterQueueInner
...
json = "{}"
# create an instance of TrafficShaperLimiterQueueInner from a JSON string
traffic_shaper_limiter_queue_inner_instance = TrafficShaperLimiterQueueInner.from_json(json)
# print the JSON string representation of the object
print(TrafficShaperLimiterQueueInner.to_json())

# convert the object into a dict
traffic_shaper_limiter_queue_inner_dict = traffic_shaper_limiter_queue_inner_instance.to_dict()
# create an instance of TrafficShaperLimiterQueueInner from a dict
traffic_shaper_limiter_queue_inner_from_dict = TrafficShaperLimiterQueueInner.from_dict(traffic_shaper_limiter_queue_inner_dict)
```
