# PatchVPNOpenVPNClientEndpointRequest
...
**mode** | **str** | The OpenVPN client mode.&lt;br&gt; | [optional] 
**dev_mode** | **str** | The carrier mode for this OpenVPN client. &#x60;tun&#x60; mode carries IPv4 and IPv6 (layer 3) and is the most common and compatible mode across all platforms. &#x60;tap&#x60; mode is capable of carrying 802.3 (layer 2).&lt;br&gt; | [optional] 
**protocol** | **str** | The protocol used by this OpenVPN client.&lt;br&gt; | [optional] 
**interface** | **str** | The interface used by the firewall to originate this OpenVPN client connection.&lt;br&gt;&lt;br&gt;This field is only available when the following conditions are met:&lt;br&gt;- &#x60;protocol&#x60; must not be one of [ UDP, TCP ]&lt;br&gt; | [optional] 
**server_addr** | **str** | The IP address or hostname of the OpenVPN server this client will connect to.&lt;br&gt; | [optional] 
**server_port** | **str** | The port used by the server to receive client connections. Valid options are: a TCP/UDP port number&lt;br&gt; | [optional] 
...
**proxy_user** | **str** | The username to use for authentication to the remote proxy.&lt;br&gt;&lt;br&gt;This field is only available when the following conditions are met:&lt;br&gt;- &#x60;proxy_authtype&#x60; must not be equal to &#x60;&#39;none&#39;&#x60;&lt;br&gt; | [optional] 
**proxy_passwd** | **str** | The username to use for authentication to the remote proxy.&lt;br&gt;&lt;br&gt;This field is only available when the following conditions are met:&lt;br&gt;- &#x60;proxy_authtype&#x60; must not be equal to &#x60;&#39;none&#39;&#x60;&lt;br&gt; | [optional] 
...
json = "{}"
# create an instance of PatchVPNOpenVPNClientEndpointRequest from a JSON string
patch_vpn_open_vpn_client_endpoint_request_instance = PatchVPNOpenVPNClientEndpointRequest.from_json(json)
# print the JSON string representation of the object
print(PatchVPNOpenVPNClientEndpointRequest.to_json())

# convert the object into a dict
patch_vpn_open_vpn_client_endpoint_request_dict = patch_vpn_open_vpn_client_endpoint_request_instance.to_dict()
# create an instance of PatchVPNOpenVPNClientEndpointRequest from a dict
patch_vpn_open_vpn_client_endpoint_request_from_dict = PatchVPNOpenVPNClientEndpointRequest.from_dict(patch_vpn_open_vpn_client_endpoint_request_dict)
```
