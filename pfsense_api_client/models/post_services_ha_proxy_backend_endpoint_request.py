...
class PostServicesHAProxyBackendEndpointRequest(BaseModel):
    """
    PostServicesHAProxyBackendEndpointRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The unique name for this backend.<br>")
    ...
    agent_port: StrictStr = Field(description=" Valid options are: a TCP/UDP port number<br><br>This field is only available when the following conditions are met:<br>- `agent_checks` must be equal to `true`<br>")
    ...
    persist_cookie_name: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The string name to track in Set-Cookie and Cookie HTTP headers.<br><br>This field is only available when the following conditions are met:<br>- `persist_cookie_enabled` must be equal to `true`<br>")
