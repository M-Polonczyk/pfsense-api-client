...
class PostRoutingGatewayGroupEndpointRequest(BaseModel):
    """
    PostRoutingGatewayGroupEndpointRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=31)] = Field(description="The name of the gateway group.<br>")
    ...
    priorities: Annotated[List[RoutingGatewayGroupPrioritiesInner], Field(min_length=1, max_length=65535)] = Field(description="The priorities of the gateways in this group.<br>")
