...
class GetDiagnosticsConfigHistoryRevisionEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[ConfigHistoryRevision] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ConfigHistoryRevision.from_dict(obj["data"]) if obj.get("data") is not None else None,
