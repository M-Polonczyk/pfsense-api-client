...
class PostFirewallRuleEndpointRequest(BaseModel):
    """
    PostFirewallRuleEndpointRequest
    """ # noqa: E501
    type: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The action to take against traffic that matches this rule.<br>")
    interface: Annotated[List[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]], Field(min_length=0, max_length=128)] = Field(description="The interface where packets must originate to match this rule.<br>")
    ipprotocol: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The IP version(s) this rule applies to.<br>")
