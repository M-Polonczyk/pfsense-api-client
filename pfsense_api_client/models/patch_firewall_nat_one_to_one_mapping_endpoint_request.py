...
class PatchFirewallNATOneToOneMappingEndpointRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["interface", "disabled", "nobinat", "natreflection", "ipprotocol", "external", "source", "destination", "descr", "id"]
