...
class PatchServicesHAProxyBackendActionEndpointRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "acl", "server", "customaction", "deny_status", "realm", "rule", "lua_function", "name", "fmt", "find", "replace", "path", "status", "reason", "parent_id", "id"]
