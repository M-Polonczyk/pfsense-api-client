...
class PostRoutingGatewayEndpointRequest(BaseModel):
    """
    PostRoutingGatewayEndpointRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=31)] = Field(description="Sets a name for the gateway.<br>")
    ...
    ipprotocol: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the Internet Protocol version this gateway uses.<br>")
    interface: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the interface this gateway will apply to.<br>")
    gateway: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the IP address of the remote gateway.<br>")
