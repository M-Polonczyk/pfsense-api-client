...
class PatchServicesACMECertificateDomainEndpointRequest(BaseModel):
    """
    PatchServicesACMECertificateDomainEndpointRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The fully-qualified domain name of this domain (SAN).<br>")
    ...
    method: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The method to use to validate this domain.<br>")
