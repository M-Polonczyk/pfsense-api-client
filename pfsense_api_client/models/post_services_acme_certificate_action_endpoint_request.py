...
class PostServicesACMECertificateActionEndpointRequest(BaseModel):
    """
    ...
    command: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The command to execute on the ACME certificate.<br>")
    method: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The action method that should be used to run the command.<br>")
    parent_id: StrictInt = Field(description="The ID of the parent this object is nested under.")
    __properties: ClassVar[List[str]] = ["status", "command", "method", "parent_id"]
