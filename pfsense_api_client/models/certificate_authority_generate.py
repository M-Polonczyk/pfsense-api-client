...
class CertificateAuthorityGenerate(BaseModel):
    """
    CertificateAuthorityGenerate
    """ # noqa: E501
    descr: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The descriptive name for this certificate authority.<br>")
    ...
    caref: Optional[StrictStr] = Field(default=None, description="The certificate authority to use as the parent for this intermediate certificate authority.<br><br>This field is only available when the following conditions are met:<br>- `is_intermediate` must be equal to `true`<br>")
    ...
    digest_alg: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The digest algorithm to use when signing certificates.<br>")
