...
class GetFirewallAdvancedSettingsEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[FirewallAdvancedSettings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FirewallAdvancedSettings.from_dict(obj["data"]) if obj.get("data") is not None else None,
