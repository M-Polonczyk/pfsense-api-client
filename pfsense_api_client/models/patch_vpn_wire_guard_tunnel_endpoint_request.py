...
class PatchVPNWireGuardTunnelEndpointRequest(BaseModel):
    """
    ...
    privatekey: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The private key for this tunnel.<br>")
    ...
    __properties: ClassVar[List[str]] = ["name", "enabled", "listenport", "publickey", "privatekey", "mtu", "addresses", "id"]
