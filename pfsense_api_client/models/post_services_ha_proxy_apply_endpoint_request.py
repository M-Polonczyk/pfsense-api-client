...
class PostServicesHAProxyApplyEndpointRequest(BaseModel):
    """
    PostServicesHAProxyApplyEndpointRequest
    """ # noqa: E501
    applied: Optional[StrictBool] = Field(default=None, description="Indicates whether all HAProxy configuration changes have been applied.<br>")
