...
class PatchVPNOpenVPNClientEndpointRequest(BaseModel):
    """
    ...
    mode: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The OpenVPN client mode.<br>")
    dev_mode: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The carrier mode for this OpenVPN client. `tun` mode carries IPv4 and IPv6 (layer 3) and is the most common and compatible mode across all platforms. `tap` mode is capable of carrying 802.3 (layer 2).<br>")
    protocol: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The protocol used by this OpenVPN client.<br>")
    interface: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The interface used by the firewall to originate this OpenVPN client connection.<br><br>This field is only available when the following conditions are met:<br>- `protocol` must not be one of [ UDP, TCP ]<br>")
    server_addr: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The IP address or hostname of the OpenVPN server this client will connect to.<br>")
    server_port: Optional[StrictStr] = Field(default=None, description="The port used by the server to receive client connections. Valid options are: a TCP/UDP port number<br>")
    ...
    proxy_user: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The username to use for authentication to the remote proxy.<br><br>This field is only available when the following conditions are met:<br>- `proxy_authtype` must not be equal to `'none'`<br>")
    proxy_passwd: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The username to use for authentication to the remote proxy.<br><br>This field is only available when the following conditions are met:<br>- `proxy_authtype` must not be equal to `'none'`<br>")
    ...
    data_ciphers: Optional[Annotated[List[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]], Field(min_length=1, max_length=128)]] = Field(default=None, description="The encryption algorithms/ciphers allowed by this OpenVPN client.<br>")
