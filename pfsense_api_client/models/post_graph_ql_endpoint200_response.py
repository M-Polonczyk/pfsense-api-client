...
class PostGraphQLEndpoint200Response(BaseModel):
    """
    PostGraphQLEndpoint200Response
    """ # noqa: E501
    data: Optional[PostAuthJWTEndpoint401ResponseAllOfData] = None
    errors: Optional[List[GraphQLResponseErrorsInner]] = Field(default=None, description="The GraphQL response errors.")
