...
class PostVPNWireGuardPeerEndpointRequest(BaseModel):
    """
    ...
    publickey: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The public key for this peer.<br>")
    ...
    __properties: ClassVar[List[str]] = ["enabled", "tun", "endpoint", "port", "descr", "persistentkeepalive", "publickey", "presharedkey", "allowedips"]
