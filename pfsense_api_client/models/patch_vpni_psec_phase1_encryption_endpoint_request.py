...
class PatchVPNIPsecPhase1EncryptionEndpointRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["encryption_algorithm_name", "encryption_algorithm_keylen", "hash_algorithm", "dhgroup", "prf_algorithm", "parent_id", "id"]
