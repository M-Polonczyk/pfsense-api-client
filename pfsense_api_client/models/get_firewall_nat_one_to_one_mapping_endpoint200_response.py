...
class GetFirewallNATOneToOneMappingEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[OneToOneNATMapping] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": OneToOneNATMapping.from_dict(obj["data"]) if obj.get("data") is not None else None,
