...
class DHCPServerPoolInner(BaseModel):
    """
    DHCPServerPoolInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["range_from", "range_to", "domain", "mac_allow", "mac_deny", "domainsearchlist", "defaultleasetime", "maxleasetime", "gateway", "dnsserver", "winsserver", "ntpserver", "ignorebootp", "ignoreclientuids", "denyunknown"]
