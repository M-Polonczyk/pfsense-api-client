...
class PostFirewallTrafficShaperLimiterEndpointRequest(BaseModel):
    """
    PostFirewallTrafficShaperLimiterEndpointRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The unique name for this limiter.<br>")
    ...
    aqm: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The Active Queue Management (AQM) algorithm to use for this limiter. AQM is the intelligent drop of network packets inside the limiter, when it becomes full or gets close to becoming full, with the goal of reducing network congestion.<br>")
    sched: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The scheduler to use for this limiter. The scheduler manages the sequence of network packets in the limiter's queue.<br>")
