...
class PatchFirewallTrafficShaperQueueEndpointRequest(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=15)]] = Field(default=None, description="The name to assign this traffic shaper queue.<br>")
    ...
    qlimit: Optional[Annotated[int, Field(le=99999999999999, strict=True, ge=1)]] = Field(default=None, description="The number of packets that can be held in a queue waiting to be transmitted by the shaper.<br>")
    ...
    bandwidth: Optional[Annotated[int, Field(le=99999999999999, strict=True, ge=1)]] = Field(default=None, description="The total bandwidth amount allowed by this traffic shaper.<br><br>This field is only available when the following conditions are met:<br>- Parent field `scheduler` must be one of [ FAIRQ, CBQ, HFSC ]<br>")
    ...
    upperlimit_m2: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The normal bandwidth limit for this traffic shaper queue. If `upperlimit_m1` is not defined, this limit will always be in effect. If `upperlimit_m1` is defined, this limit will take effect after the `upperlimit_d` duration has expired.<br><br>This field is only available when the following conditions are met:<br>- `upperlimit` must be equal to `true`<br>")
    ...
    realtime_m2: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The maximum bandwidth this traffic shaper queue is allowed to use. Note: This value should not exceed 30% of parent queue's maximum bandwidth.<br><br>This field is only available when the following conditions are met:<br>- `realtime` must be equal to `true`<br>")
    ...
    __properties: ClassVar[List[str]] = ["interface", "enabled", "name", "priority", "qlimit", "description", "default", "red", "rio", "ecn", "codel", "bandwidthtype", "bandwidth", "buckets", "hogs", "borrow", "upperlimit", "upperlimit_m1", "upperlimit_d", "upperlimit_m2", "realtime", "realtime_m1", "realtime_d", "realtime_m2", "linkshare", "linkshare_m1", "linkshare_d", "linkshare_m2", "parent_id", "id"]
