...
class PostServicesACMECertificateEndpointRequest(BaseModel):
    """
    PostServicesACMECertificateEndpointRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The name of the ACME certificate.<br>")
    ...
    acmeaccount: StrictStr = Field(description="The ACME account key to use for the ACME certificate.<br>")
    ...
    keypaste: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The custom private key to use for the ACME certificate.<br><br>This field is only available when the following conditions are met:<br>- `keylength` must be equal to `'custom'`<br>")
    ...
    a_domainlist: Annotated[List[ACMECertificateADomainlistInner], Field(min_length=1, max_length=100)] = Field(description="The list of domain verifications  to include in the ACME certificate.<br>")
