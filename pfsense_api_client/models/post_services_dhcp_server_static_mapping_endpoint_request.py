...
class PostServicesDHCPServerStaticMappingEndpointRequest(BaseModel):
    """
    PostServicesDHCPServerStaticMappingEndpointRequest
    """ # noqa: E501
    mac: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The MAC address of the client this mapping is for.<br>")
    ...
    __properties: ClassVar[List[str]] = ["mac", "ipaddr", "cid", "hostname", "domain", "domainsearchlist", "defaultleasetime", "maxleasetime", "gateway", "dnsserver", "winsserver", "ntpserver", "arp_table_static_entry", "descr", "parent_id"]
