...
class PostServicesHAProxyFrontendAddressEndpointRequest(BaseModel):
    """
    PostServicesHAProxyFrontendAddressEndpointRequest
    """ # noqa: E501
    extaddr: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The external address to use.<br>")
    extaddr_custom: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The custom IPv4 or IPv6 address to use as the external address.<br><br>This field is only available when the following conditions are met:<br>- `extaddr` must be equal to `'custom'`<br>")
    ...
    __properties: ClassVar[List[str]] = ["extaddr", "extaddr_custom", "extaddr_port", "extaddr_ssl", "exaddr_advanced", "parent_id"]
