...
class GetServicesBINDZonesEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[List[BINDZone]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [BINDZone.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
