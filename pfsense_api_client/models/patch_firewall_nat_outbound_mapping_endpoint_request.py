...
class PatchFirewallNATOutboundMappingEndpointRequest(BaseModel):
    """
    PatchFirewallNATOutboundMappingEndpointRequest
    """ # noqa: E501
    interface: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The interface on which traffic is matched as it exits the firewall. In most cases this is a WAN-type or another externally-connected interface.<br>")
    ...
    __properties: ClassVar[List[str]] = ["interface", "protocol", "disabled", "nonat", "nosync", "source", "source_port", "destination", "destination_port", "target", "target_subnet", "nat_port", "static_nat_port", "poolopts", "source_hash_key", "descr", "id"]
