...
class PostAuthJWTEndpoint422Response(BaseModel):
    """
    PostAuthJWTEndpoint422Response
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=422, description="The HTTP status code that corresponds with the API response.")
    status: Optional[StrictStr] = Field(default='unprocessable entity', description="The HTTP status message that corresponds with the HTTP status code.")
    ...
    data: Optional[PostAuthJWTEndpoint401ResponseAllOfData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code") if obj.get("code") is not None else 422,
            "status": obj.get("status") if obj.get("status") is not None else 'unprocessable entity',
            "response_id": obj.get("response_id"),
            "message": obj.get("message"),
            "data": PostAuthJWTEndpoint401ResponseAllOfData.from_dict(obj["data"]) if obj.get("data") is not None else None,
