...
class PatchServicesDNSResolverHostOverrideAliasEndpointRequest(BaseModel):
    """
    PatchServicesDNSResolverHostOverrideAliasEndpointRequest
    """ # noqa: E501
    host: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="The hostname portion of the host override alias.<br>")
    domain: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="The hostname portion of the host override alias.<br>")
    ...
    __properties: ClassVar[List[str]] = ["host", "domain", "descr", "parent_id", "id"]
