...
class PutSystemRESTAPIAccessListEndpointRequestInner(BaseModel):
    """
    ...
    network: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The network (in CIDR notation) that this entry applies to. Clients interacting with the REST API from this network will be affected by this entry.<br>")
    ...
    __properties: ClassVar[List[str]] = ["type", "weight", "network", "users", "sched", "descr"]
