...
class PatchServicesDHCPServerStaticMappingEndpointRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mac", "ipaddr", "cid", "hostname", "domain", "domainsearchlist", "defaultleasetime", "maxleasetime", "gateway", "dnsserver", "winsserver", "ntpserver", "arp_table_static_entry", "descr", "parent_id", "id"]
