...
class PostAuthJWTEndpoint405Response(BaseModel):
    """
    PostAuthJWTEndpoint405Response
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=405, description="The HTTP status code that corresponds with the API response.")
    status: Optional[StrictStr] = Field(default='method not allowed', description="The HTTP status message that corresponds with the HTTP status code.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": obj.get("status") if obj.get("status") is not None else 'method not allowed',
