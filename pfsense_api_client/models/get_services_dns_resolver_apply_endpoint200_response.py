...
class GetServicesDNSResolverApplyEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[DNSResolverApply] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": DNSResolverApply.from_dict(obj["data"]) if obj.get("data") is not None else None,
