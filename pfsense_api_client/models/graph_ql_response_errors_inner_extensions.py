...
class GraphQLResponseErrorsInnerExtensions(BaseModel):
    """
    The error extensions.
    """ # noqa: E501
    response_id: Optional[StrictStr] = Field(default=None, description="The error response ID.")
    __properties: ClassVar[List[str]] = ["response_id"]
