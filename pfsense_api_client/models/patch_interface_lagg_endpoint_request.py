...
class PatchInterfaceLAGGEndpointRequest(BaseModel):
    """
    ...
    members: Optional[Annotated[List[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]], Field(min_length=1, max_length=128)]] = Field(default=None, description="A list of member interfaces to include in the LAGG.<br>")
    proto: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The LAGG protocol to use.<br>")
    ...
    __properties: ClassVar[List[str]] = ["laggif", "descr", "members", "proto", "lacptimeout", "lagghash", "failovermaster", "id"]
