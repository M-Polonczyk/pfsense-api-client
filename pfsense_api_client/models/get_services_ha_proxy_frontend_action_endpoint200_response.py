...
class GetServicesHAProxyFrontendActionEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[HAProxyFrontendAction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": HAProxyFrontendAction.from_dict(obj["data"]) if obj.get("data") is not None else None,
