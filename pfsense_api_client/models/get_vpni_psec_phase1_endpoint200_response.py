...
class GetVPNIPsecPhase1Endpoint200Response(BaseModel):
    """
    ...
    data: Optional[IPsecPhase1] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": IPsecPhase1.from_dict(obj["data"]) if obj.get("data") is not None else None,
