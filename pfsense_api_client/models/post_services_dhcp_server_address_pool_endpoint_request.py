...
class PostServicesDHCPServerAddressPoolEndpointRequest(BaseModel):
    """
    PostServicesDHCPServerAddressPoolEndpointRequest
    """ # noqa: E501
    range_from: Annotated[str, Field(min_length=0, strict=True, max_length=15)] = Field(description="The starting IP address for this address pool. This address must be less than or equal to the `range_to` field.<br>")
    range_to: Annotated[str, Field(min_length=0, strict=True, max_length=15)] = Field(description="The ending IP address for the this address pool. This address must be greater than or equal to the `range_to` field.<br>")
    ...
    __properties: ClassVar[List[str]] = ["range_from", "range_to", "domain", "mac_allow", "mac_deny", "domainsearchlist", "defaultleasetime", "maxleasetime", "gateway", "dnsserver", "winsserver", "ntpserver", "ignorebootp", "ignoreclientuids", "denyunknown", "parent_id"]
