...
class PatchServicesHAProxyBackendServerEndpointRequest(BaseModel):
    """
    PatchServicesHAProxyBackendServerEndpointRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=1024)]] = Field(default=None, description="The unique name for this backend server.<br>")
    ...
    address: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The hostname or IP address of this backend server. Hostname values are only resolved at service startup.<br>")
    port: Optional[StrictStr] = Field(default=None, description="The port to forward to for this backend server. Valid options are: a TCP/UDP port number<br>")
    ...
    __properties: ClassVar[List[str]] = ["name", "status", "address", "port", "weight", "ssl", "sslserververify", "serverid", "parent_id", "id"]
