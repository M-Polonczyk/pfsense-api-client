...
class PostSystemRESTAPISettingsSyncEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[RESTAPISettingsSync] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": RESTAPISettingsSync.from_dict(obj["data"]) if obj.get("data") is not None else None,
