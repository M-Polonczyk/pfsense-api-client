...
class PostServicesDNSForwarderHostOverrideEndpointRequest(BaseModel):
    """
    PostServicesDNSForwarderHostOverrideEndpointRequest
    """ # noqa: E501
    host: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The hostname of this override.<br>")
    domain: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The domain of this override.<br>")
    ip: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The IP address of this override.<br>")
