...
class PostFirewallNATOneToOneMappingEndpointRequest(BaseModel):
    """
    PostFirewallNATOneToOneMappingEndpointRequest
    """ # noqa: E501
    interface: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The interface this 1:1 NAT mapping applies to.<br>")
