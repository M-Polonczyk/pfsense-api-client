...
class PostServicesDNSResolverAccessListEndpointRequest(BaseModel):
    """
    PostServicesDNSResolverAccessListEndpointRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The name of this access list.<br>")
    action: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The action to take when an access list match is found.<br>")
    ...
    networks: Annotated[List[DNSResolverAccessListNetworksInner], Field(min_length=0, max_length=65535)] = Field(description="The DNS Resolver access list network entries to include in this access list.<br>")
    __properties: ClassVar[List[str]] = ["name", "action", "description", "networks"]
