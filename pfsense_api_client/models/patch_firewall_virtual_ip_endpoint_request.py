...
class PatchFirewallVirtualIPEndpointRequest(BaseModel):
    """
    ...
    mode: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The virtual IP mode to use for this virtual IP.<br>")
    interface: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The interface this virtual IP will apply to.<br>")
    ...
    subnet: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The address for this virtual IP.<br>")
    subnet_bits: Optional[Annotated[int, Field(le=128, strict=True, ge=1)]] = Field(default=None, description="The subnet bits for this virtual IP. For `proxyarp` and `other` virtual IPs, this value specifies a block of many IP address. For all other virtual IP modes, this specifies the subnet mask<br>")
    ...
    vhid: Optional[Annotated[int, Field(le=255, strict=True, ge=1)]] = Field(default=None, description="The VHID group that the machines will share.<br><br>This field is only available when the following conditions are met:<br>- `mode` must be equal to `'carp'`<br>")
    ...
    password: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The VHID group password shared by all CARP members.<br><br>This field is only available when the following conditions are met:<br>- `mode` must be equal to `'carp'`<br>")
    ...
    carp_peer: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The IP address of the CARP peer. Please note this field is exclusive to pfSense Plus and has no effect on CE.<br><br>This field is only available when the following conditions are met:<br>- `carp_mode` must be equal to `'ucast'`<br>")
    id: StrictInt = Field(description="The ID of the object or resource to interact with.")
    __properties: ClassVar[List[str]] = ["uniqid", "mode", "interface", "type", "subnet", "subnet_bits", "descr", "noexpand", "vhid", "advbase", "advskew", "password", "carp_status", "carp_mode", "carp_peer", "id"]
