...
class PostSystemCRLRevokedCertificateEndpointRequest(BaseModel):
    """
    PostSystemCRLRevokedCertificateEndpointRequest
    """ # noqa: E501
    certref: StrictStr = Field(description="The reference ID of the certificate to be revoked<br><br>This field is only available when the following conditions are met:<br>- `serial` must be equal to `NULL`<br>")
    ...
    revoke_time: Annotated[int, Field(le=99999999999999, strict=True, ge=0)] = Field(description="The unix timestamp of when the certificate was revoked.<br>")
    ...
    __properties: ClassVar[List[str]] = ["certref", "serial", "reason", "revoke_time", "caref", "descr", "type", "crt", "prv", "parent_id"]
