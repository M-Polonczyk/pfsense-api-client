...
class GetFirewallNATOutboundMappingEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[OutboundNATMapping] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": OutboundNATMapping.from_dict(obj["data"]) if obj.get("data") is not None else None,
