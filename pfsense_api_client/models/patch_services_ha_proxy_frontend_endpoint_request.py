...
class PatchServicesHAProxyFrontendEndpointRequest(BaseModel):
    """
    PatchServicesHAProxyFrontendEndpointRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=1024)]] = Field(default=None, description="The unique name for this HAProxy frontend.<br>")
    ...
    type: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The processing type for this frontend.<br>")
    ...
    __properties: ClassVar[List[str]] = ["name", "descr", "status", "a_extaddr", "max_connections", "type", "ha_acls", "a_actionitems", "backend_serverpool", "socket_stats", "dontlognull", "dontlog_normal", "log_separate_errors", "log_detailed", "a_errorfiles", "client_timeout", "forwardfor", "httpclose", "advanced_bind", "advanced", "ssloffloadcert", "ha_certificates", "id"]
