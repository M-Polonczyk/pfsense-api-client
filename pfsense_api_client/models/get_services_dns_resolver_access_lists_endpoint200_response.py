...
class GetServicesDNSResolverAccessListsEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[List[DNSResolverAccessList]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [DNSResolverAccessList.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
