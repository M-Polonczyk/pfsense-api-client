...
class PatchFirewallTrafficShaperEndpointRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["enabled", "interface", "name", "scheduler", "bandwidthtype", "bandwidth", "qlimit", "tbrconfig", "queue", "id"]
