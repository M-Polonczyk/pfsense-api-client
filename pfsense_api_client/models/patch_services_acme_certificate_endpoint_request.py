...
class PatchServicesACMECertificateEndpointRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "descr", "status", "acmeaccount", "keylength", "keypaste", "preferredchain", "oscpstaple", "dnssleep", "renewafter", "a_domainlist", "a_actionlist", "id"]
