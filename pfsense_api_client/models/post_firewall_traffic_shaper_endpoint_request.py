...
class PostFirewallTrafficShaperEndpointRequest(BaseModel):
    """
    ...
    interface: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The interface this traffic shaper will be applied to.<br>")
    ...
    scheduler: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The scheduler type to use for this traffic shaper. Changing this value will automatically update any child queues assigned to this traffic shaper.<br>")
    bandwidthtype: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The scale type of the `bandwidth` field's value.<br>")
    bandwidth: Annotated[int, Field(le=99999999999999, strict=True, ge=1)] = Field(description="The total bandwidth amount allowed by this traffic shaper.<br>")
