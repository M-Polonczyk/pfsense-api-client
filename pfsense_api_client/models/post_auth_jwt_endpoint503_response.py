...
class PostAuthJWTEndpoint503Response(BaseModel):
    """
    PostAuthJWTEndpoint503Response
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=503, description="The HTTP status code that corresponds with the API response.")
    status: Optional[StrictStr] = Field(default='service unavailable', description="The HTTP status message that corresponds with the HTTP status code.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code") if obj.get("code") is not None else 503,
            "status": obj.get("status") if obj.get("status") is not None else 'service unavailable',
