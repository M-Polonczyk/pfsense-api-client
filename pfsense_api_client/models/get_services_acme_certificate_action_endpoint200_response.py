...
class GetServicesACMECertificateActionEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[ACMECertificateAction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ACMECertificateAction.from_dict(obj["data"]) if obj.get("data") is not None else None,
