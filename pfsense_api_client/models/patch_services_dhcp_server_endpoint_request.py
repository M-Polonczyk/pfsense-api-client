...
class PatchServicesDHCPServerEndpointRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["interface", "enable", "range_from", "range_to", "domain", "failover_peerip", "mac_allow", "mac_deny", "domainsearchlist", "defaultleasetime", "maxleasetime", "gateway", "dnsserver", "winsserver", "ntpserver", "staticarp", "ignorebootp", "ignoreclientuids", "nonak", "disablepingcheck", "dhcpleaseinlocaltime", "statsgraph", "denyunknown", "pool", "numberoptions", "staticmap", "id"]
