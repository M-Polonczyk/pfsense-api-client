...
class PostNetworkInterfaceEndpointRequest(BaseModel):
    """
    PostNetworkInterfaceEndpointRequest
    """ # noqa: E501
    var_if: Annotated[str, Field(min_length=0, strict=True, max_length=128)] = Field(description="The real interface this configuration will be applied to.<br>", alias="if")
    enable: Optional[StrictBool] = Field(default=None, description="Enable or disable this interface.<br>")
    descr: Annotated[str, Field(min_length=0, strict=True, max_length=128)] = Field(description="The descriptive name for this interface.<br>")
    ...
    typev4: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Selects the IPv4 address type to assign this interface.<br>")
    ipaddr: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the IPv4 address to assign to this interface.<br><br>This field is only available when the following conditions are met:<br>- `typev4` must be one of [ static, dhcp ]<br>")
    subnet: Annotated[int, Field(le=32, strict=True, ge=1)] = Field(description="Sets the subnet bit count to assign this interface.<br><br>This field is only available when the following conditions are met:<br>- `typev4` must be equal to `'static'`<br>")
    ...
    ipaddrv6: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the IPv6 address to assign to this interface.<br><br>This field is only available when the following conditions are met:<br>- `typev6` must be one of [ staticv6, dhcp6, slaac, 6rd, track6, 6to4 ]<br>")
    subnetv6: Annotated[int, Field(le=128, strict=True, ge=1)] = Field(description="Sets the subnet bit count to assign this interface.<br><br>This field is only available when the following conditions are met:<br>- `typev6` must be equal to `'staticv6'`<br>")
    ...
    prefix_6rd: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the 6RD IPv6 prefix assigned by the ISP for this interface.<br><br>This field is only available when the following conditions are met:<br>- `typev6` must be equal to `'6rd'`<br>")
    gateway_6rd: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the 6RD IPv4 gateway address assigned by the ISP for this interface.<br><br>This field is only available when the following conditions are met:<br>- `typev6` must be equal to `'6rd'`<br>")
    prefix_6rd_v4plen: Annotated[int, Field(le=32, strict=True, ge=0)] = Field(description="Sets the 6RD IPv4 prefix length. Normally specified by the ISP. A value of 0 means embed theentire IPv4 address in the 6RD prefix.<br><br>This field is only available when the following conditions are met:<br>- `typev6` must be equal to `'6rd'`<br>")
    track6_interface: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the dynamic IPv6 WAN interface to track for configuration.<br><br>This field is only available when the following conditions are met:<br>- `typev6` must be equal to `'track6'`<br>")
