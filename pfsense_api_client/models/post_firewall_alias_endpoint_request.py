...
class PostFirewallAliasEndpointRequest(BaseModel):
    """
    PostFirewallAliasEndpointRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=31)] = Field(description="Sets the name for the alias. This name must be unique from all other aliases.<br>")
    type: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="Sets the type of alias this object will be. This directly impacts what values can be                 specified in the `address` field.<br>")
