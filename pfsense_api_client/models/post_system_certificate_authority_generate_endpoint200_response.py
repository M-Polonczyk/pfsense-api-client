...
class PostSystemCertificateAuthorityGenerateEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[CertificateAuthorityGenerate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CertificateAuthorityGenerate.from_dict(obj["data"]) if obj.get("data") is not None else None,
