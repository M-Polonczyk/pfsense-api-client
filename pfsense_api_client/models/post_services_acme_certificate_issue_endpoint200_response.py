...
class PostServicesACMECertificateIssueEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[ACMECertificateIssue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ACMECertificateIssue.from_dict(obj["data"]) if obj.get("data") is not None else None,
