...
class GetVPNIPsecPhase2EncryptionEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[IPsecPhase2Encryption] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": IPsecPhase2Encryption.from_dict(obj["data"]) if obj.get("data") is not None else None,
