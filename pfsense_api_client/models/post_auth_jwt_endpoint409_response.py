...
class PostAuthJWTEndpoint409Response(BaseModel):
    """
    PostAuthJWTEndpoint409Response
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=409, description="The HTTP status code that corresponds with the API response.")
    status: Optional[StrictStr] = Field(default='conflict', description="The HTTP status message that corresponds with the HTTP status code.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code") if obj.get("code") is not None else 409,
            "status": obj.get("status") if obj.get("status") is not None else 'conflict',
