...
class PatchUserGroupEndpointRequest(BaseModel):
    """
    PatchUserGroupEndpointRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=64)]] = Field(default=None, description="The name for this user group.<br>")
    ...
    __properties: ClassVar[List[str]] = ["name", "gid", "scope", "description", "member", "priv", "id"]
