...
class PostInterfaceGREEndpointRequest(BaseModel):
    """
    PostInterfaceGREEndpointRequest
    """ # noqa: E501
    var_if: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The pfSense interface interface serving as the local address to be used for the GRE tunnel.<br>", alias="if")
    ...
    remote_addr: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The remote address to use for the GRE tunnel.<br>")
    ...
    tunnel_remote_addr: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The remote IPv4 address to use for the GRE tunnel.<br><br>This field is only available when the following conditions are met:<br>- `tunnel_local_addr` must not be equal to `NULL`<br>")
    ...
    tunnel_remote_addr6: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The remote IPv6 address to use for the GRE tunnel.<br><br>This field is only available when the following conditions are met:<br>- `tunnel_local_addr6` must not be equal to `NULL`<br>")
    ...
    __properties: ClassVar[List[str]] = ["if", "greif", "descr", "add_static_route", "remote_addr", "tunnel_local_addr", "tunnel_remote_addr", "tunnel_remote_net", "tunnel_local_addr6", "tunnel_remote_addr6", "tunnel_remote_net6"]
