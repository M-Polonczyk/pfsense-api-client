...
class PostSystemCertificateEndpointRequest(BaseModel):
    """
    ...
    prv: StrictStr = Field(description="The X509 private key string.<br>")
    __properties: ClassVar[List[str]] = ["descr", "refid", "caref", "type", "csr", "crt", "prv"]
