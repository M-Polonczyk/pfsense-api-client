...
class CertificateSigningRequestSign(BaseModel):
    """
    ...
    caref: Optional[StrictStr] = Field(default=None, description="The certificate authority to sign the certificate with.<br>")
    csr: Optional[StrictStr] = Field(default=None, description="The X509 certificate signing request to sign.<br>")
