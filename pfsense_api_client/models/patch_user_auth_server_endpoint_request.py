...
class PatchUserAuthServerEndpointRequest(BaseModel):
    """
    ...
    type: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The type of this authentication server.<br>")
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The descriptive name for this authentication server.<br>")
    host: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The remote IP address or hostname of the authentication server.<br>")
    ldap_port: Optional[StrictStr] = Field(default=None, description="The LDAP port to connect to on this LDAP authentication server. Valid options are: a TCP/UDP port number<br><br>This field is only available when the following conditions are met:<br>- `type` must be equal to `'ldap'`<br>")
    ldap_urltype: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The encryption mode to use when connecting to this authentication server. Use `Standard TCP` for unencrypted LDAP connections, use `STARTTLS Encrypt` to start an encrypted connection via STARTTLS if it's available, or `SSL/TLS Encrypted` to only use LDAPS encrypted connections.<br><br>This field is only available when the following conditions are met:<br>- `type` must be equal to `'ldap'`<br>")
    ...
    ldap_bindpw: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The password to use when binding to this authentication server.<br><br>This field is only available when the following conditions are met:<br>- `type` must be equal to `'ldap'`<br>- `ldap_binddn` must not be equal to `NULL`<br>")
    ...
    radius_secret: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="The shared secret to use when authenticating to this RADIUS server.<br><br>This field is only available when the following conditions are met:<br>- `type` must be equal to `'radius'`<br>")
