...
class PostVPNOpenVPNCSOEndpointRequest(BaseModel):
    """
    PostVPNOpenVPNCSOEndpointRequest
    """ # noqa: E501
    common_name: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The X.509 common name for the client certificate, or the username for VPNs utilizing password authentication.<br>")
