...
class GetServicesDNSForwarderHostOverrideAliasEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[DNSForwarderHostOverrideAlias] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": DNSForwarderHostOverrideAlias.from_dict(obj["data"]) if obj.get("data") is not None else None,
