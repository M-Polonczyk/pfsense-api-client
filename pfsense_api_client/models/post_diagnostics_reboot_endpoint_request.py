...
class PostDiagnosticsRebootEndpointRequest(BaseModel):
    """
    PostDiagnosticsRebootEndpointRequest
    """ # noqa: E501
    dry_run: Optional[StrictBool] = Field(default=None, description="Run through the call but don't actually initiate a reboot.<br>")
