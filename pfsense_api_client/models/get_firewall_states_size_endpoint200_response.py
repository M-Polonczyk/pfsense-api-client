...
class GetFirewallStatesSizeEndpoint200Response(BaseModel):
    """
    ...
    data: Optional[FirewallStatesSize] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FirewallStatesSize.from_dict(obj["data"]) if obj.get("data") is not None else None,
