...
class TestGetServicesHAProxyBackendsEndpoint200Response(unittest.TestCase):
    """GetServicesHAProxyBackendsEndpoint200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetServicesHAProxyBackendsEndpoint200Response:
        """Test GetServicesHAProxyBackendsEndpoint200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetServicesHAProxyBackendsEndpoint200Response`
        """
        model = GetServicesHAProxyBackendsEndpoint200Response()
        if include_optional:
            return GetServicesHAProxyBackendsEndpoint200Response(
                code = 56,
                status = 'ok',
                response_id = '',
                message = '',
                data = [
                    openapi_client.models.ha_proxy_backend.HAProxyBackend(
                        name = '', 
                        servers = [
                            null
                            ], 
    ...
    def testGetServicesHAProxyBackendsEndpoint200Response(self):
        """Test GetServicesHAProxyBackendsEndpoint200Response"""
