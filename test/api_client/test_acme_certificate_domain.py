...
class TestACMECertificateDomain(unittest.TestCase):
    """ACMECertificateDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ACMECertificateDomain:
        """Test ACMECertificateDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ACMECertificateDomain`
        """
        model = ACMECertificateDomain()
        if include_optional:
            return ACMECertificateDomain(
                name = '',
                status = 'enable',
                method = '',
                webrootfolder = '',
    ...
    def testACMECertificateDomain(self):
        """Test ACMECertificateDomain"""
