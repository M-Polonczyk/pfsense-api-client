...
class TestTrafficShaperLimiter(unittest.TestCase):
    """TrafficShaperLimiter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrafficShaperLimiter:
        """Test TrafficShaperLimiter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrafficShaperLimiter`
        """
        model = TrafficShaperLimiter()
        if include_optional:
            return TrafficShaperLimiter(
                name = '',
                number = 0,
                enabled = True,
                mask = 'none',
    ...
    def testTrafficShaperLimiter(self):
        """Test TrafficShaperLimiter"""
