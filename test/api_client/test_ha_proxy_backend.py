...
class TestHAProxyBackend(unittest.TestCase):
    """HAProxyBackend unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HAProxyBackend:
        """Test HAProxyBackend
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HAProxyBackend`
        """
