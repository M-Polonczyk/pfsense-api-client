...
class TestPostServicesACMECertificateDomainEndpointRequest(unittest.TestCase):
    """PostServicesACMECertificateDomainEndpointRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostServicesACMECertificateDomainEndpointRequest:
        """Test PostServicesACMECertificateDomainEndpointRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostServicesACMECertificateDomainEndpointRequest`
        """
        model = PostServicesACMECertificateDomainEndpointRequest()
        if include_optional:
            return PostServicesACMECertificateDomainEndpointRequest(
                name = '',
                status = 'enable',
                method = '',
                webrootfolder = '',
    ...
    def testPostServicesACMECertificateDomainEndpointRequest(self):
        """Test PostServicesACMECertificateDomainEndpointRequest"""
