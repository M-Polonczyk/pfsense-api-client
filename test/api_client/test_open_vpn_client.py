...
class TestOpenVPNClient(unittest.TestCase):
    """OpenVPNClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenVPNClient:
        """Test OpenVPNClient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenVPNClient`
        """
        model = OpenVPNClient()
        if include_optional:
