...
class TestOpenVPNServer(unittest.TestCase):
    """OpenVPNServer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenVPNServer:
        """Test OpenVPNServer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenVPNServer`
        """
        model = OpenVPNServer()
        if include_optional:
