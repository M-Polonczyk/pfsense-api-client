...
class TestPatchServicesHAProxyBackendEndpointRequest(unittest.TestCase):
    """PatchServicesHAProxyBackendEndpointRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchServicesHAProxyBackendEndpointRequest:
        """Test PatchServicesHAProxyBackendEndpointRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchServicesHAProxyBackendEndpointRequest`
        """
        model = PatchServicesHAProxyBackendEndpointRequest()
        if include_optional:
            return PatchServicesHAProxyBackendEndpointRequest(
                name = '',
                servers = [
                    null
                    ],
    ...
    def testPatchServicesHAProxyBackendEndpointRequest(self):
        """Test PatchServicesHAProxyBackendEndpointRequest"""
