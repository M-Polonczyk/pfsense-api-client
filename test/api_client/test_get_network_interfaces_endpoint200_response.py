...
class TestGetNetworkInterfacesEndpoint200Response(unittest.TestCase):
    """GetNetworkInterfacesEndpoint200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNetworkInterfacesEndpoint200Response:
        """Test GetNetworkInterfacesEndpoint200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNetworkInterfacesEndpoint200Response`
        """
        model = GetNetworkInterfacesEndpoint200Response()
        if include_optional:
            return GetNetworkInterfacesEndpoint200Response(
                code = 56,
                status = 'ok',
                response_id = '',
                message = '',
    ...
    def testGetNetworkInterfacesEndpoint200Response(self):
        """Test GetNetworkInterfacesEndpoint200Response"""
